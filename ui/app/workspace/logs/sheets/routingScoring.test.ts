...
describe("parseProviderScoringLogs", () => {
	it("parses scoring rows, cooldown skips, fail-open, and selected provider", () => {
		const logs = [
			"[1780000000000] [governance] - Provider scoring provider-alpha model gpt-4o: avail=0.90 ttft=0.80 cost=1.00 final=0.88 weight 1.00 -> 0.88",
			"[1780000000001] [governance] - Provider scoring provider-beta model gpt-4o: avail=0.20 ttft=0.50 cost=0.70 final=0.33 weight 1.00 -> 0.33",
