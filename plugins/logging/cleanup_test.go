...
func TestCleanupDrainsRecoveredBatchNoDrops(t *testing.T) {
	...
	plugin, err := Init(context.Background(), &Config{}, testLogger{}, rec, nil)
	if err != nil {
...
func TestCleanupIsIdempotent(t *testing.T) {
	plugin, err := Init(context.Background(), &Config{}, testLogger{}, newTestStore(t), nil)
	if err != nil {
		t.Fatalf("Init() error = %v", err)
	}
	if err := plugin.Cleanup(); err != nil {
...
func TestWriterConfigDefaultsAndInitOverrides(t *testing.T) {
	...
	plugin, err = Init(context.Background(), &Config{Writer: writer}, testLogger{}, newTestStore(t), nil)
	if err != nil {
