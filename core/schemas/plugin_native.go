...
// EventBroadcaster is a generic callback for broadcasting typed events to connected clients.
// Any plugin or subsystem can use this to push updates to the frontend.
