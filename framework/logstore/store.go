...
type LogStore interface {
	...
	GetTTFTHistogram(ctx context.Context, filters SearchFilters, bucketSizeSeconds int64) (*LatencyHistogramResult, error)
	...
	GetProviderTTFTHistogram(ctx context.Context, filters SearchFilters, bucketSizeSeconds int64) (*ProviderLatencyHistogramResult, error)
	GetTTFBStats(ctx context.Context, filters SearchFilters, window time.Duration, minSamples int) (*TTFBStatsResult, error)
	GetTTFTStats(ctx context.Context, filters SearchFilters, window time.Duration, minSamples int) (*TTFTStatsResult, error)
